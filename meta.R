...
setwd("C:/meta2016")
j_file <-"talks_art.json"
j_file1 <-"talks_free.json"
j_file2 <-"talks_music.json"
j_file3 <-"talks_time.json"

###Read a json file to workspace
talk_creativ1<-fromJSON(file=j_file, method="C")
talk_creativ2<-fromJSON(file=j_file1, method="C")
talk_creativ3<-fromJSON(file=j_file2, method="C")
talk_creativ4<-fromJSON(file=j_file3, method="C")
talk_creativ<-c(talk_creativ1,talk_creativ2,talk_creativ3,talk_creativ4)
str(talk_creativ)
